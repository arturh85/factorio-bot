...
export type AppSettings = { client_count: number; enable_autostart: boolean; enable_restapi: boolean; factorio_archive_path: string; map_exchange_string: string; rcon_pass: string; rcon_port: number; recreate: boolean; seed: string; workspace_path: string };
