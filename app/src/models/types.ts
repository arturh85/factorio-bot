...
export type PlayerChangedDistanceEvent = { playerId: PlayerId; buildDistance: number; reachDistance: number; dropItemDistance: number; itemPickupDistance: number; lootPickupDistance: number; resourceReachDistance: number };
export type PlayerChangedPositionEvent = { playerId: PlayerId; position: Position };
export type PlayerChangedMainInventoryEvent = { playerId: PlayerId; mainInventory: { [key: string]: number } };
export type PlayerLeftEvent = { playerId: PlayerId };
...
export type FactorioPlayer = { playerId: PlayerId; position: Position; mainInventory: { [key: string]: number };
