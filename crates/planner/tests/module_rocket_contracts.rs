...
fn installed_launch_has_the_space_age_research_and_payload_contract() {
    let f: LaunchPrototypeFixture =
        serde_json::from_str(include_str!("fixtures/rocket-2.1.17.json"))
